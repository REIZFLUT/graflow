    ...
    */
    ...
    'providers' => [
        ...
        'openai' => [
            ...
            // Keep requests stateless so proxies such as LiteLLM receive the
            // full context on each call. The forum-media Azure deployment is
            // reached through the OpenAI driver via the LiteLLM proxy.
