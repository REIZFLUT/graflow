...
return [
    ...
    'spellcheck' => [
        ...
        'error_not_configured' => 'LanguageTool is not configured. Please add the credentials to the server configuration.',
        'error_unavailable' => 'LanguageTool is currently unavailable. Please try again later.',
        'dismiss' => 'Dismiss',
        'apply' => 'Apply',
